...
public class CClientThread extends Thread {
    ...
    public CClientThread(String masterAddress,String headAddress,int masterPortNo,int headPortNo, String info,String bankName,int waitTime,int id)
    {
        ...
        try 
        {
            ...
            while (true) {
                ...
                */
                    ...
                    DatagramPacket packet = new DatagramPacket(buf, buf.length, address, headPortNo);
                    socket.send(packet);
                    ...
                    System.out.println("received = " + received + "for client = " + id);
